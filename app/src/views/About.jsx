            ...
            <section className="flex flex-col w-full justify-center items-center pt-20 pb-20 gap-1 px-5 md:px-10">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-7" >
                    <p className="text-secondary200 text-sm md:text-lg text-center">
                        Ballopolis is meant to be a <b className="font-bold">social game</b>, where you <b className="font-bold">create levels</b> that are fun and challenging to beat for other players. In doing so, you get <b className="font-bold">Customization Credits</b> to create more levels or chose a new avatar. While playing you can also <b className="font-bold">earn achivements</b> to add to your profile and show off to your friends.
                    </p>
